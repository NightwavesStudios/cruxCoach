...
function exportLocalStorage() {
    const keysToSave = ["grades", "trainingData", "traits"];
...
function importLocalStorage() {
    ...
    reader.onload = function (event) {
        try {
            ...
            const confirmed = confirm("This will overwrite your current data. Proceed?");
            if (!confirmed) return;
...
function restoreBackup() {
    ...
    const confirmed = confirm("Restore backup? This will overwrite your current data.");
    if (!confirmed) return;
